# Contributing to the HSDP terraform provider

We'd love for you to contribute to our source code and to make HSDP terraform provider even better than it is today!
...
In Github, send a pull request to original main branch: f.e. `terraform-provider-hsdp:main`.
